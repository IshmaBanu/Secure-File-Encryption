      ...
      fr.onload = async () => { //load
        ...
        await window.crypto.subtle.encrypt({
          ...
          .then(function (encrypted) {
            ...
            resolve(processFinished('Encrypted-' + file.name, [iv, DEC.salt, new Uint8Array(encrypted)], 1, password.value)); //create the new file buy adding signature and iv and content
